 ...
 *
 * A public install can end up with `origin=git@github.com:BlusceLabs/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/BlusceLabs/hermes-agent.git'
