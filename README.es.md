...
# Hermes Agent ☤
<p align="center">
  <a href="https://bluscelabs.github.io/hermes-agent/">Hermes Agent</a> | <a href="https://bluscelabs.github.io/hermes-agent/">Hermes Desktop</a>
</p>
<p align="center">
  <a href="https://bluscelabs.github.io/hermes-agent/docs/"><img src="https://img.shields.io/badge/Docs-hermes--agent.nousresearch.com-FFD700?style=for-the-badge" alt="Documentación"></a>
  <a href="https://discord.gg/NousResearch"><img src="https://img.shields.io/badge/Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white" alt="Discord"></a>
  <a href="https://github.com/BlusceLabs/hermes-agent/blob/main/LICENSE"><img src="https://img.shields.io/badge/Licencia-MIT-green?style=for-the-badge" alt="Licencia: MIT"></a>
...
```bash
curl -fsSL https://bluscelabs.github.io/hermes-agent/scripts/install.sh | bash
```

### Windows (nativo, PowerShell)

> **Nota:** En Windows nativo, Hermes funciona sin WSL — la CLI, el gateway, la TUI y las herramientas funcionan de forma nativa. Si prefieres usar WSL2, el comando de Linux/macOS de arriba también funciona allí. ¿Encontraste un error? Por favor [crea un issue](https://github.com/BlusceLabs/hermes-agent/issues).

Ejecuta esto en PowerShell:

```powershell
iex (irm https://bluscelabs.github.io/hermes-agent/scripts/install.ps1)
```
...
> **Android / Termux:** La ruta manual probada está documentada en la [guía de Termux](https://bluscelabs.github.io/hermes-agent/docs/getting-started/termux). En Termux, Hermes instala el extra `.[termux]` curado porque el extra completo `.[all]` actualmente incluye dependencias de voz incompatibles con Android.
>
...
📖 **[Documentación completa →](https://bluscelabs.github.io/hermes-agent/docs/)**
...
Esto te autentica vía OAuth, establece Nous como tu proveedor y activa el Tool Gateway. Comprueba qué está conectado en cualquier momento con `hermes portal info`. Detalles completos en la [página de documentación del Tool Gateway](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/tool-gateway).
...
Para las listas de comandos completas, consulta la [guía de CLI](https://bluscelabs.github.io/hermes-agent/docs/user-guide/cli) y la [guía del Gateway de Mensajería](https://bluscelabs.github.io/hermes-agent/docs/user-guide/messaging).

---

## Documentación

Toda la documentación está en **[bluscelabs.github.io/hermes-agent/docs](https://bluscelabs.github.io/hermes-agent/docs/)**:

| Sección                                                                                             | Contenido                                                    |
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [Inicio rápido](https://bluscelabs.github.io/hermes-agent/docs/getting-started/quickstart)              | Instalar → configurar → primera conversación en 2 minutos   |
| [Uso de CLI](https://bluscelabs.github.io/hermes-agent/docs/user-guide/cli)                             | Comandos, atajos de teclado, personalidades, sesiones        |
| [Configuración](https://bluscelabs.github.io/hermes-agent/docs/user-guide/configuration)               | Archivo de configuración, proveedores, modelos, todas las opciones |
| [Gateway de Mensajería](https://bluscelabs.github.io/hermes-agent/docs/user-guide/messaging)           | Telegram, Discord, Slack, WhatsApp, Signal, Home Assistant   |
| [Seguridad](https://bluscelabs.github.io/hermes-agent/docs/user-guide/security)                        | Aprobación de comandos, emparejamiento por DM, aislamiento en contenedor |
| [Herramientas y Toolsets](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/tools)   | Más de 40 herramientas, sistema de toolsets, backends de terminal |
| [Sistema de Habilidades](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/skills)   | Memoria procedimental, Skills Hub, creación de habilidades   |
| [Memoria](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/memory)                   | Memoria persistente, perfiles de usuario, mejores prácticas  |
| [Integración MCP](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/mcp)              | Conecta cualquier servidor MCP para capacidades extendidas   |
| [Programación Cron](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/cron)           | Tareas programadas con entrega a plataforma                  |
| [Archivos de Contexto](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/context-files) | Contexto de proyecto que da forma a cada conversación      |
| [Arquitectura](https://bluscelabs.github.io/hermes-agent/docs/developer-guide/architecture)            | Estructura del proyecto, bucle del agente, clases principales |
| [Contribuir](https://bluscelabs.github.io/hermes-agent/docs/developer-guide/contributing)              | Configuración de desarrollo, proceso de PR, estilo de código |
| [Referencia de CLI](https://bluscelabs.github.io/hermes-agent/docs/reference/cli-commands)             | Todos los comandos y flags                                   |
| [Variables de Entorno](https://bluscelabs.github.io/hermes-agent/docs/reference/environment-variables) | Referencia completa de variables de entorno                  |
...
```bash
git clone https://github.com/BlusceLabs/hermes-agent.git
cd hermes-agent
...
- 🐛 [Issues](https://github.com/BlusceLabs/hermes-agent/issues)
