...
def get_hermes_home() -> Path:
    ...
    ``hermes_cli/kanban_db.py``).  See https://github.com/BlusceLabs/hermes-agent/issues/18594.
    """
...
def secure_parent_dir(path: Path) -> None:
    ...
    See https://github.com/BlusceLabs/hermes-agent/issues/25821.
    """
...
def is_container() -> bool:
    ...
    See: BlusceLabs/hermes-agent#47111
    """
