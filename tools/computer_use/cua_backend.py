...
def _resolve_mcp_invocation(
    ...
    *,
    ...
    Surface 8 of BlusceLabs/hermes-agent#47072: instead of hardcoding
...
def _parse_elements_from_structured(raw_elements: List[Dict[str, Any]]) -> List[UIElement]:
    """Surface 2 of BlusceLabs/hermes-agent#47072: read the canonical
...
class _CuaDriverSession:
    ...
    def __init__(self, bridge: _AsyncBridge) -> None:
        ...
        self._started = False
        # Surface 4 of BlusceLabs/hermes-agent#47072: per-tool
...
def _extract_tool_result(mcp_result: Any) -> Dict[str, Any]:
    ...
    BlusceLabs/hermes-agent#47072). Each entry corresponds index-for-index
...
class CuaDriverBackend(ComputerUseBackend):
    ...
    def __init__(self) -> None:
        ...
        # Surface 6 of BlusceLabs/hermes-agent#47072: per-snapshot
    ...
    def capture(self, mode: str = "som", app: Optional[str] = None) -> CaptureResult:
        ...
        # Surface 3 of BlusceLabs/hermes-agent#47072: read the canonical
        ...
        if mode == "vision":
            ...
            # Surface 2 of BlusceLabs/hermes-agent#47072: prefer the
    ...
    def click(
        ...
        *,
        ...
        # BlusceLabs/hermes-agent#47072). cua-driver-rs gained an explicit
