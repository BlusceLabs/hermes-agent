...
_DOCS_BASE = "https://bluscelabs.github.io/hermes-agent/docs"
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://bluscelabs.github.io/hermes-agent/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://bluscelabs.github.io/hermes-agent/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
