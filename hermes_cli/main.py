...
def _print_curator_first_run_notice() -> None:
    ...
    print(
        "  Docs:         https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/curator"
    )
...
def _update_via_zip(args):
    ...
    if branch != "main":
        ...
        sys.exit(1)
    zip_url = (
        f"https://github.com/BlusceLabs/hermes-agent/archive/refs/heads/{branch}.zip"
    )
...
OFFICIAL_REPO_URLS = {
    "https://github.com/BlusceLabs/hermes-agent.git",
    "git@github.com:BlusceLabs/hermes-agent.git",
    "https://github.com/BlusceLabs/hermes-agent",
    "git@github.com:BlusceLabs/hermes-agent",
}
OFFICIAL_REPO_URL = "https://github.com/BlusceLabs/hermes-agent.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from BlusceLabs/hermes-agent.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/BlusceLabs/hermes-agent.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/BlusceLabs/hermes-agent.git' to add later."
            )
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    if not git_dir.exists():
        if sys.platform == "win32":
            ...
            print(
                "  curl -fsSL https://bluscelabs.github.io/hermes-agent/install.sh | bash"
            )
            sys.exit(1)
...
def main():
    ...
    fallback_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/fallback-providers"
        ),
    )
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://bluscelabs.github.io/hermes-agent/docs/user-guide/secrets/bitwarden"
        ),
    )
