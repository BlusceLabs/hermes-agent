...
_UPSTREAM_REPO_URL = "https://github.com/BlusceLabs/hermes-agent.git"
...
_RELEASE_URL_BASE = "https://github.com/BlusceLabs/hermes-agent/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    canonical BlusceLabs/hermes-agent repo (forks don't get a link).
    """
