...
def _perform_uninstall(
    *,
    ...
    if not full_uninstall:
        ...
        if _is_windows():
            print(color("  iex (irm https://bluscelabs.github.io/hermes-agent/install.ps1)", Colors.DIM))
        else:
            print(color("  curl -fsSL https://bluscelabs.github.io/hermes-agent/install.sh | bash", Colors.DIM))
        print()
