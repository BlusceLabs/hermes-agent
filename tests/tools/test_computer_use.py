...
class TestClickButtonPassthrough:
    """Surface 5 (BlusceLabs/hermes-agent#47072) — `middle_click` must
...
class TestImageMimeTypePropagation:
    """Surface 7 (BlusceLabs/hermes-agent#47072): trycua/cua#1961 made
...
class TestMcpInvocationResolution:
    """Surface 8 (BlusceLabs/hermes-agent#47072): instead of hardcoding
...
class TestStructuredElementsConsumption:
    """Surface 2 (BlusceLabs/hermes-agent#47072): trycua/cua#1961 made
...
class TestCapabilityDiscovery:
    """Surface 4 (BlusceLabs/hermes-agent#47072): the wrapper learns
...
class TestElementTokenAttachment:
    """Surface 6 (BlusceLabs/hermes-agent#47072): trycua/cua#1961 added
