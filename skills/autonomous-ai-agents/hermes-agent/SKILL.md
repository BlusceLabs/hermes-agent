...
metadata:
  hermes:
    ...
    homepage: https://github.com/BlusceLabs/hermes-agent
...
**Docs:** https://bluscelabs.github.io/hermes-agent/docs/
...
- User documentation: https://bluscelabs.github.io/hermes-agent/docs/
- Source tree: https://github.com/BlusceLabs/hermes-agent
...
Platform docs: https://bluscelabs.github.io/hermes-agent/docs/user-guide/messaging/
...
authoritative list or see the [live slash commands reference](https://bluscelabs.github.io/hermes-agent/docs/reference/slash-commands).
...
Full config reference: https://bluscelabs.github.io/hermes-agent/docs/user-guide/configuration
...
Full provider docs: https://bluscelabs.github.io/hermes-agent/docs/integrations/providers
...
User docs: https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/cron
...
User docs: https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/curator
...
User docs: https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/kanban
...
|----------------|----------|
| Config options | `hermes config edit` or [Configuration docs](https://bluscelabs.github.io/hermes-agent/docs/user-guide/configuration) |
| Available tools | `hermes tools list` or [Tools reference](https://bluscelabs.github.io/hermes-agent/docs/reference/tools-reference) |
| Slash commands | `/help` in session or [Slash commands reference](https://bluscelabs.github.io/hermes-agent/docs/reference/slash-commands) |
| Skills catalog | `hermes skills browse` or [Skills catalog](https://bluscelabs.github.io/hermes-agent/docs/reference/skills-catalog) |
| Provider setup | `hermes model` or [Providers guide](https://bluscelabs.github.io/hermes-agent/docs/integrations/providers) |
| Platform setup | `hermes gateway setup` or [Messaging docs](https://bluscelabs.github.io/hermes-agent/docs/user-guide/messaging/) |
| MCP servers | `hermes mcp list` or [MCP guide](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/mcp) |
| Profiles | `hermes profile list` or [Profiles docs](https://bluscelabs.github.io/hermes-agent/docs/user-guide/profiles) |
| Cron jobs | `hermes cron list` or [Cron docs](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/cron) |
| Memory | `hermes memory status` or [Memory docs](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/memory) |
| Env variables | `hermes config env-path` or [Env vars reference](https://bluscelabs.github.io/hermes-agent/docs/reference/environment-variables) |
| CLI commands | `hermes --help` or [CLI reference](https://bluscelabs.github.io/hermes-agent/docs/reference/cli-commands) |
...
For occasional contributors and PR authors. Full developer docs: https://bluscelabs.github.io/hermes-agent/docs/developer-guide/
