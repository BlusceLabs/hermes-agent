...
Built for [Hermes Agent](https://github.com/BlusceLabs/hermes-agent). Usable in any coding agent. Canonical source lives here; synced to [`BlusceLabs/hermes-agent/skills/creative/ascii-video`](https://github.com/BlusceLabs/hermes-agent/tree/main/skills/creative/ascii-video) via PR.
