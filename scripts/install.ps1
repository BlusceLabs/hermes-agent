...
$RepoUrlSsh = "git@github.com:BlusceLabs/hermes-agent.git"
$RepoUrlHttps = "https://github.com/BlusceLabs/hermes-agent.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/BlusceLabs/hermes-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/BlusceLabs/hermes-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/BlusceLabs/hermes-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://bluscelabs.github.io/hermes-agent/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
