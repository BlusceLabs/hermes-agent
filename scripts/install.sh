...
# Configuration
REPO_URL_SSH="git@github.com:BlusceLabs/hermes-agent.git"
REPO_URL_HTTPS="https://github.com/BlusceLabs/hermes-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://bluscelabs.github.io/hermes-agent/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
