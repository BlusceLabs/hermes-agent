    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/BlusceLabs/hermes-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://bluscelabs.github.io/hermes-agent/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/BlusceLabs/hermes-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/BlusceLabs/hermes-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://bluscelabs.github.io/hermes-agent/' },
            { label: 'GitHub', href: 'https://github.com/BlusceLabs/hermes-agent' },
