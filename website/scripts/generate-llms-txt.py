...
Both publish at:
  https://bluscelabs.github.io/hermes-agent/docs/llms.txt
  https://bluscelabs.github.io/hermes-agent/docs/llms-full.txt
...
SITE_BASE = "https://bluscelabs.github.io/hermes-agent/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/BlusceLabs/hermes-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://bluscelabs.github.io/hermes-agent/docs\n",
        "Short index: https://bluscelabs.github.io/hermes-agent/docs/llms.txt\n",
        "\n---\n\n",
    ]
