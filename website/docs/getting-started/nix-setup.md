...
```bash
# Run the desktop app
nix run github:BlusceLabs/hermes-agent#desktop

# Or install persistently
nix profile install github:BlusceLabs/hermes-agent#desktop

# run the tui
nix run github:BlusceLabs/hermes-agent -- setup
nix run github:BlusceLabs/hermes-agent -- --tui

# or install it in your profile
nix profile install github:BlusceLabs/hermes-agent
hermes setup
hermes --tui
```
...
# /etc/nixos/flake.nix (or your system flake)
{
  inputs = {
    ...
    hermes-agent.url = "github:BlusceLabs/hermes-agent";
  };
...
```nix
{
  inputs.hermes-agent.url = "github:BlusceLabs/hermes-agent";
