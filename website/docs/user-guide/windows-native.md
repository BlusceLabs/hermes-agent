...
```powershell
iex (irm https://raw.githubusercontent.com/BlusceLabs/hermes-agent/main/scripts/install.ps1)
```
...
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/BlusceLabs/hermes-agent/main/scripts/install.ps1))) -NoVenv -SkipSetup -Branch main
```
