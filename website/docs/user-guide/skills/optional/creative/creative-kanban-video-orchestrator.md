...
team-design JSON. See **[references/kanban-setup.md](https://github.com/BlusceLabs/hermes-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/kanban-setup.md)**
...
playbook, see **[references/monitoring.md](https://github.com/BlusceLabs/hermes-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/monitoring.md)**.
...
task graphs. See **[references/examples.md](https://github.com/BlusceLabs/hermes-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/examples.md)**.
