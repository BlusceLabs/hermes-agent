...
```bash
curl -fsSL https://bluscelabs.github.io/hermes-agent/scripts/install.sh | bash -s -- --no-skills
```
...
[Skills Hub](https://bluscelabs.github.io/hermes-agent/docs) page — instead of a
