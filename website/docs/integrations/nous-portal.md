...
If a model is genuinely missing, [open an issue](https://github.com/BlusceLabs/hermes-agent/issues) — we surface the Portal's catalog to Hermes and gaps usually mean a routing config we can update.
