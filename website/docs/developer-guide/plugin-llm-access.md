...
* Implementation: [`agent/plugin_llm.py`](https://github.com/BlusceLabs/hermes-agent/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/BlusceLabs/hermes-agent/blob/main/tests/agent/test_plugin_llm.py)
