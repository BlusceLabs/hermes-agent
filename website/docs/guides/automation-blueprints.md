...
hermes cron create "0 2 * * *" \
  "You are a project manager triaging the BlusceLabs/hermes-agent GitHub repo.

1. Run: gh issue list --repo BlusceLabs/hermes-agent --state open --json number,title,labels,author,createdAt --limit 30
...
hermes cron create "0 9 * * 1" \
  "Scan the BlusceLabs/hermes-agent repo for documentation drift.

1. Run: gh pr list --repo BlusceLabs/hermes-agent --state merged --json number,title,files,mergedAt --limit 30
