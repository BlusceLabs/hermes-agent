...
[Download the Hermes Desktop installer](https://bluscelabs.github.io/hermes-agent/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).
...
Prefer to review first? Download [`install.sh`](https://bluscelabs.github.io/hermes-agent/scripts/install.sh), inspect it, then run it.
