...
```bash
pip install git+https://github.com/BlusceLabs/hermes-agent.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/BlusceLabs/hermes-agent.git
```

You can also pin it in your `requirements.txt`:

```text
hermes-agent @ git+https://github.com/BlusceLabs/hermes-agent.git
```
