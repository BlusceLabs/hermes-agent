...
* 实现：[`agent/plugin_llm.py`](https://github.com/BlusceLabs/hermes-agent/blob/main/agent/plugin_llm.py)
* 测试：[`tests/agent/test_plugin_llm.py`](https://github.com/BlusceLabs/hermes-agent/blob/main/tests/agent/test_plugin_llm.py)
* 参考 plugin（配套仓库）：
