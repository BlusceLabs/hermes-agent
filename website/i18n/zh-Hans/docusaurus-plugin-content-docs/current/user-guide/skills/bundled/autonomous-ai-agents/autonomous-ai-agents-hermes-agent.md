...
**文档：** https://bluscelabs.github.io/hermes-agent/docs/
...
平台文档：https://bluscelabs.github.io/hermes-agent/docs/user-guide/messaging/
...
在交互式聊天会话中输入这些命令。新命令会不定期上线；如果以下内容看起来过时，请在会话内运行 `/help` 获取权威列表，或查看[实时斜杠命令参考](https://bluscelabs.github.io/hermes-agent/docs/reference/slash-commands)。命令注册表的权威来源是 `hermes_cli/commands.py` — 每个消费方（自动补全、Telegram 菜单、Slack 映射、`/help`）均从中派生。
...
完整配置参考：https://bluscelabs.github.io/hermes-agent/docs/user-guide/configuration
...
完整提供商文档：https://bluscelabs.github.io/hermes-agent/docs/integrations/providers
...
用户文档：https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/cron
...
用户文档：https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/curator
...
用户文档：https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/kanban
...
| 查找内容... | 位置 |
|----------------|----------|
| 配置选项 | `hermes config edit` 或[配置文档](https://bluscelabs.github.io/hermes-agent/docs/user-guide/configuration) |
| 可用工具 | `hermes tools list` 或[工具参考](https://bluscelabs.github.io/hermes-agent/docs/reference/tools-reference) |
| 斜杠命令 | 会话内 `/help` 或[斜杠命令参考](https://bluscelabs.github.io/hermes-agent/docs/reference/slash-commands) |
| Skill 目录 | `hermes skills browse` 或[Skill 目录](https://bluscelabs.github.io/hermes-agent/docs/reference/skills-catalog) |
| 提供商设置 | `hermes model` 或[提供商指南](https://bluscelabs.github.io/hermes-agent/docs/integrations/providers) |
| 平台设置 | `hermes gateway setup` 或[消息文档](https://bluscelabs.github.io/hermes-agent/docs/user-guide/messaging/) |
| MCP 服务器 | `hermes mcp list` 或[MCP 指南](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/mcp) |
| Profiles | `hermes profile list` 或[Profiles 文档](https://bluscelabs.github.io/hermes-agent/docs/user-guide/profiles) |
| Cron 任务 | `hermes cron list` 或[Cron 文档](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/cron) |
| 记忆 | `hermes memory status` 或[记忆文档](https://bluscelabs.github.io/hermes-agent/docs/user-guide/features/memory) |
| 环境变量 | `hermes config env-path` 或[环境变量参考](https://bluscelabs.github.io/hermes-agent/docs/reference/environment-variables) |
| CLI 命令 | `hermes --help` 或[CLI 参考](https://bluscelabs.github.io/hermes-agent/docs/reference/cli-commands) |
...
面向偶尔贡献者和 PR 作者。完整开发者文档：https://bluscelabs.github.io/hermes-agent/docs/developer-guide/
