...
如果你发现 bug，请[提交 issue](https://github.com/BlusceLabs/hermes-agent/issues)，附上 `hermes logs --since 5m` 的输出。在标题中注明 `codex-runtime` 以便于分类处理。
...
有关实现细节，请参阅 [PR #24182](https://github.com/BlusceLabs/hermes-agent/pull/24182) 和 [Codex app-server 协议 README](https://github.com/openai/codex/blob/main/codex-rs/app-server/README.md)。